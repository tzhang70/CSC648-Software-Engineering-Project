...
require_once "config.php";
    ...
    {
      $sql = "INSERT INTO appointments_list (notes, start_event, student_id, professor_id, end_event, student_name)
        VALUES ('".$_POST['eventNotes']."', '".$_POST['eventDate']."', '".$_SESSION['id']."', '1', '".$_POST['eventEndDate']."','".$_SESSION['name']."')";
    ...
    $sql = "SELECT appointment_id as id, notes as description, start_event as start, end_event as end, student_name as title FROM appointments_list WHERE professor_id='".$_SESSION['id']."'";
          ...
          var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dateClick: function(info) {
              ...
              //info.dayEl.style.backgroundColor = 'red';
                                                   ...
                                                   alert('Current desc: ' + info.event.description);
                                                    $('#calendarModal').modal();
                                                   },
